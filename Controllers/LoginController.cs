...
namespace Hotel.Controllers
{
    ...
    {
        private Models.Login.LoginDBContext db = new Models.Login.LoginDBContext();
        ...
        public ActionResult Display(String Email,String Password)
        {
            //query
            
            return Content($"{Email} /n  {Password}" );
        }
